...
function Footer() {
	return (
		<div className="bg-white py-4 sm:pt-10 sm:pb-6 mt-12">
				...
				<div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-y-4">
					<nav>
						...
						<ul className="grid grid-cols-2 sm:grid-cols-1 gap-y-3">
							<li>
								<a href="#">
									<img className='transform  transition hover:scale-105'
          ...
          <nav className='flex items-center justify-around '>
            <a href="" className='w-24 h-28 border-2 shadow-sm flex items-center justify-center rounded-lg '>
            <img className='w-16 h-20 ' src="https://getir.com/_next/static/images/etbis-33c159729adc8b4e2b946310f038d2f4.png" alt="" />
